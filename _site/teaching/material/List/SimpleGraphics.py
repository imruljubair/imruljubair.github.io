...
#  Copyright (C) 2013, 2014 Ben Stephenson
#
...
def setFont(f=None, s=10, modifiers=""):
  ...
  if f == None:
    ...
    try:
      __font = font.Font(font=(f, s, modifiers))
      return True
    except:
      __font = None
      return False
...
def getPixel(img, x, y):
  ...
  # (rather than delete it, I just made it a comment)
  #parts = img.get(x, y).split()

  # this is what it is now - the split function call was removed
  parts = img.get(x, y)

  # and the return statement has been changed as well
  # this actually does the work of the split function, manually
